...
dataFile1 = 'Fishing_new.mat'  # mat文件路径，data为名字，其中的变量名为A
...
x = tf.placeholder(tf.float32, [None, fea_num, fea_num])  #
...
for i in range(batchnum):
    ...
    if flag == 1:
        ...
        #     x: testset, y_: testlabel, keep_prob: kp1}))
        ...
        saver.save(sess, './{}data/fishdect_deep{}.ckpt'.format(steplenth,i))
